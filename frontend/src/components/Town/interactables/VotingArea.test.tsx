...
// ***************************************** NOTE: THIS IS A SKELETON FOR THE TESTS FOR JOINING AND LEAVING A VOTINGAREA (inspired from ViewingAreaVideo and VotingArea tests from the backend)
// THESE TESTS WILL NEED TO BE UPDATED AFTER FRONTEND VOTINGAREA IS IMPLEMENTED, AND VOTING DATA STORAGE SYSTEM IS IMPLEMENTED ******************************************
...
describe('VotingArea', () => {
  ...
  beforeEach(() => {
    ...
    // votingArea = new VotingAreaController({});
  ...
  describe('join', () => {
    ...
    it('Initializes votingTopic prop to undefined or players votingTopicLabel when first player joins', () => {});
